...
const Footer = () => {
    return (
        <>
         <div className="italic font-serif mt-4 ml-12 mr-12 text-justify indent-6">
          <h3 className="text-xl font-bold text-pink-800">Bibliografia</h3>
          <br></br>
          <ul className="text-left ml-2 text-justify">
            <li>* CATTARUZZA, A (2009) "Otras dimensiones de la experiencia peronista" en Historia Argentina 1916-1955,  Buenos Aires, Siglo XXI p: 229-250 . *</li>
          ...
          <hr className="my-8 h-1 h-px bg-rose-300 h-px border-0"></hr>
          <p className="text-right italic mr-20 font-bold">Florencia Anabel Vazquez</p>
          </div>
